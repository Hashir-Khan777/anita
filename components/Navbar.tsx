...
function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between px-4 md:px-[70px] py-[20px]">
      ...
      <div className="whitespace-nowrap hidden lg:flex flex-row justify-center items-center lg:gap-[35px] gap-[20px]">
        <Link
          target="_blank"
      ...
      <aside
        ...
        } z-40 w-64 h-full transition-transform`}
        aria-label="Sidebar"
      >
        <div className="h-full px-6 py-4 overflow-y-auto bg-black">
          <div className="w-full flex items-end justify-end">
            <button
              ...
              className="text-white bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
            >
              <svg
                aria-hidden="true"
                className="w-5 h-5"
          ...
          <div className="whitespace-nowrap flex mt-4 flex-col justify-center items-center lg:gap-[35px] gap-[20px]">
            <Link
              target="_blank"
              href="https://www.instagram.com/itsanitaai/"
        ...
        >
          <img src="./images/youtube.svg" alt="" />
            ...
            >
              <a target="_blank">
                <button
                  className="font-fielder capitalize text-[13px] font-bold text-primary border-primary border-2 rounded-[8px] h-[55px] md:px-3  px-2"
                  style={{
                    background: "linear-gradient(135deg,#0d1407 50%,#6AB131)",
                  }}
                >
